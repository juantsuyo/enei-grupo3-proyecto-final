...
def reset_inputs():
    global field_edad, field_nro_personas_trabajo, field_horas_trabajo, field_select_sexo, field_select_NIVELI, field_select_Informal_P
...
with col_a:
    st.button('Predecir', on_click=boton_ver, use_container_width=True)

with col_b:
    st.button('Resetear', on_click=boton_ocultar, use_container_width=True)
